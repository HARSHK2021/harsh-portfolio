  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:harshsagar396@gmail.com">
          <MagicButton
      ...
      <div className="flex flex-col items-center mt-10 ">
        <div className="text-4xl font-semibold ">FIND ME ON</div>
        <div className="text-2xl mt-2 flex flex-col items-center text-purple ">
